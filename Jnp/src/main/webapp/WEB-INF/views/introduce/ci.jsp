...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <img class="logo"
                src="${pageContext.request.contextPath}/resources/img/ilgin.jpg">
        </div>
        
        <div class="col-md-3 text">
            <p>JJ C&P의 코퍼리트 심볼마크는 JJ C&P을 대표하는 상징적인 조형으로서 JJ C&P의 코퍼리트 아이덴티피케이션
        ...
        <div class="col-md-3 text">
            ...
            <p>정교한 프린팅과 기술, 선진 프로세스 문화를 정착시키며 '업체의 만족이 곧 JJ C&P의 기쁨(곡선의 웃음)으로
