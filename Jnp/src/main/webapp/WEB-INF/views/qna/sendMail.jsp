...
<body>
	...
	<div class="container">
		<form id="form" action="/qna/qnaContents" method="post">
			...
			<div class="form-group">
				<label>제목:</label><br> <input type="text" class="form-control"
					id="title" name="title" placeholder="  Subject">
			</div>
			...
			<div class="form-group">
				<label for="checkbox label"> <input type="checkbox"
					...
					정보를 수집하는 데에 동의합니다. <br />(원칙적으로 이용목적이 달성된 후에는 관련법령 또는 회사 내부 방침에
					따라서 보존할 필요가 있는 경우를 제외하고는 지체없이 파기됩니다.)
				</label>
			</div>
			<div class="btn">
				<button type="button" class="btn btn-primary" id="btnclick">Send
					Message</button>
			</div>
		</form>
	</div>
